...
const MODELS = ['gemini-2.0-flash', 'gemini-2.5-flash', 'gemini-1.5-pro-latest'] as const;
...
export async function complete(
  ...
  try {
    const result = await chat.sendMessage(prompt, { signal: controller.signal, timeout: TIMEOUT_MS });
